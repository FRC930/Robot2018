...
// Right Right 1
public class MotionProfile6A implements Runnable {
	...
	public static void init() {
		...
		Waypoint[] rightRightScale = AutoHandler.rightRightScale; // Vel: 3.0
		...
		Trajectory tra = Pathfinder.generate(rightRightScale, config);
