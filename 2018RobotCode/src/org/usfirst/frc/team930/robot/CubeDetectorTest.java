...
/**
* CubeDectectorTest class.
*
* <p>An OpenCV pipeline generated by GRIP.
*
* @author GRIP
*/
public class CubeDetectorTest implements VisionPipeline 
{
	 ...
	 */
	public CubeDetectorTest(int width, int height)
	{
		IMG_WIDTH = width;
		IMG_HEIGHT = height;
	}
	...
	public void process(Mat source0) 
	{
		...
		double[] hsvThresholdHue = {16.130598261171635, 92.2043116360154};
		double[] hsvThresholdSaturation = {112.0, 255.0};
		double[] hsvThresholdValue = {69.45295040441462, 206.54255926340255};
		...
		double[] findBlobsCircularity = {0.02209326826225753, 0.33447098976109224};
		...
		double filterContoursMinArea = 0.00520833333 * (IMG_WIDTH * IMG_HEIGHT);
		double filterContoursMinPerimeter = 0.0375 * (IMG_WIDTH * 2 + IMG_HEIGHT * 2);
		double filterContoursMinWidth = 0.0375 * IMG_WIDTH;
		double filterContoursMaxWidth = 0.9375 * IMG_WIDTH;
		double filterContoursMinHeight = 0.0375 * IMG_HEIGHT;
		double filterContoursMaxHeight = 0.9375 * IMG_HEIGHT;
		double[] filterContoursSolidity = {62, 100};
	...
	{
		if (kernel == null) kernel = new Mat();
		if (anchor == null) anchor = new Point(-1,-1);
		if (borderValue == null) borderValue = new Scalar(-1);
	...
	private void findContours(Mat input, boolean externalOnly, List<MatOfPoint> contours)
	{
		...
		int mode;
		if (externalOnly) mode = Imgproc.RETR_EXTERNAL;
		else mode = Imgproc.RETR_LIST;
